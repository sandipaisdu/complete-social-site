...
$query = mysqli_query($connection, $tbl_useroptions); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $tbl_friends); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $tbl_blockedusers); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $tbl_status); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $tbl_photos); 
if ($query === TRUE) {
...
$query = mysqli_query($connection, $tbl_notifications); 
if ($query === TRUE) {
